...
import net.smartworks.tle.model.PcbReport;
import net.smartworks.tle.model.PcbReportCond;
import net.smartworks.tle.model.SensorReport;
import net.smartworks.tle.model.SensorReportCond;
import net.smartworks.tle.model.SummaryBarChartData;
import net.smartworks.tle.model.SummaryLineChartData;
import net.smartworks.tle.model.SummaryReport;
import net.smartworks.tle.model.SummaryReportCond;
import net.smartworks.tle.model.SummaryReportPop;
import net.smartworks.tle.model.SummaryReportPopCond;
import net.smartworks.tle.model.SummaryReportPopRSet;
